<div class="bg-light" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush my-3">
        ...
        <div class="collapse ps-3" id="productsCollapse">
            <a href="products.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold switch">Lista
                produktów</a>
        </div>
        <a href="messages.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold switch">
            <i class="fas fa-paperclip me-2"></i>Wiadomości
        </a>
        <a href="logout.php" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold switch">
